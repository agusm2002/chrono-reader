...
struct EnhancedComicViewer: View {
    ...
    // Barra superior
    // Top bar moved to `Views/ComicViewer/ComicTopBar.swift`
    private var topBar: some View { ComicTopBar(model: model) }
    
    // Barra inferior
    // Bottom bar moved to `Views/ComicViewer/ComicBottomBar.swift`
    private var bottomBar: some View { ComicBottomBar(model: model) }
}
...
class IVPagingController: UIViewController {
    ...
    deinit {
        // Limpiar observadores y cancelar suscripciones para evitar memory leaks
...
// ComicSettingsView and its subcomponents moved to `Views/ComicViewer/ComicSettingsView.swift`
